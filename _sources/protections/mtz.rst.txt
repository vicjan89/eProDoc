...
.. list-table:: Для расчёта уставок необходимо заполнить поля:
   ...
   * - Коэффициент возврата органа минимального напряжения
     - для расчёта пуска по напряжению
   * - Направление
     - указывается для направленных МТЗ. Если не указано то в отчёте этот параметр не упоминается.\nВозможные варианты: от шин в линию, от линии к шинам, ненаправленная.
