...
В главном меню выбрерити пункт Войти, затем введите имя пользователя и пароль, указанные при регистрации, нажмите на кнопку Войти.
...
Далее сверху в выпадающем меню Действие выберите пункт "Сформировать расчёт уставок РЗА" и нажмите кнопку "Выполнить". 
